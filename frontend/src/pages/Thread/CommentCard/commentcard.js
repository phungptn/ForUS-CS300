    ...
    return (
        <div className="card-body comment-card"style={{ margin: '20px 0' }} id={comment._id}>
            <div className="row m-0 p-0">
                <div className="col-md-2 bg-card-secondary round-left d-flex flex-column align-items-center text-center"
                ...
                <div className="col-md-10 bg-card-primary round-right d-flex flex-column justify-content-between">
